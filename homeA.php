<?php
session_start();
if (isset($_SESSION['aname']) && isset($_SESSION['adEmail']) && isset($_SESSION['adPassword'])) {
?>
...
<div  class="content">
  ...
  <h1> Hy , <?php echo $_SESSION['aname']; ?> ! </h1>
  <h2>Passwword:  <?php echo $_SESSION['adPassword']; ?> </h2>
  <h3>Email :  <?php echo $_SESSION['adEmail']; ?> </h3>
</div>
</div>
