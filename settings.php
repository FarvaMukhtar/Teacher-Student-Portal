<?php
session_start();
if (isset($_SESSION['Name']) && isset($_SESSION['Password']) && isset($_SESSION['Gender']) && 
isset($_SESSION['stdEmail']) && isset($_SESSION['stdID']) && isset($_SESSION['phnmbr']) ) {
?>
...
<div  class="content">
  ...
  <h3>ID        :  <?php echo $_SESSION['stdID']; ?> </h3>
  <h3>Ph-Number :  <?php echo $_SESSION['phnmbr']; ?> </h3>
